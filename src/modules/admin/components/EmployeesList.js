...
const EmployeesList = React.forwardRef(
    ...
    const columns = [
      {
        ...
        width: "250px",
        cell: (row) => (
          <div className=" flex items-center py-1   text-wrap ">
            <img
            ...
            />
            <CustomText
              className=" font-custom font-bold text-sm pl-3      text-cblack"
              text={row.name}
            ></CustomText>
          </div>
        ),
      },
      {
        ...
        sortable: true,
        cell: (row) => <div className="py-1  text-sm w-full ">{row.email}</div>,
      },
      {
        name: "Position",
        selector: (row) => row.role,
        sortable: true,
        cell: (row) => <div className="py-1  text-sm w-full ">{row.role}</div>,
      },
      {
        name: "Employee ID",
        selector: (row) => row.postalCode,
        cell: (row) => (
          <div className="py-1  text-sm w-full ">{row.postalCode}</div>
        ),
      },
